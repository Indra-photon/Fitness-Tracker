...
const Dashboard = () => {
  ...
  const { steps, calories, water, heartRate, sleep, activeMinutes } = dailyMetrics;
          ...
          <div className="bg-gradient-to-br from-[#2a7e35] to-[#0F172A] rounded-xl shadow-lg border border-[#334155] p-5 hover:shadow-[0_8px_30px_rgba(244,114,182,0.15)] transition-shadow duration-300">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <h3 className="text-2xl font-bold text-white">{heartRate.current} <span className="text-sm text-gray-400 font-normal">bpm</span></h3>
              </div>
              <div className="w-16 h-16 flex items-center justify-center">
                <Heart className="text-[#F472B6] w-10 h-10" />
              </div>
            </div>
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-400">Resting: {heartRate.average} bpm</span>
              <span className="text-[#F472B6] font-medium">Normal</span>
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#ecedee] to-[#0B1325] p-4 md:p-8 flex items-center justify-center">
      ...
      <div className="flex flex-col w-full max-w-7xl bg-[#0F172A] text-white font-sans rounded-2xl shadow-[0_0_50px_rgba(139,92,246,0.1)]">
        ...
        <header className="bg-[#1E293B] border-b border-[#334155] shadow-md rounded-t-2xl">
          <div className="container mx-auto px-6 py-4 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-bold text-white tracking-wide">FitTrack</h1>
            </div>
            <div className="flex items-center space-x-4">
              <button className="p-2 rounded-full hover:bg-[#334155] transition-colors">
                <Bell size={20} className="text-gray-300" />
              </button>
              <div className="w-9 h-9 rounded-full bg-gradient-to-r from-[#8B5CF6] to-[#6D28D9] flex items-center justify-center shadow-md">
          ...
          <aside className="hidden md:flex w-16 flex-col items-center px-2 py-8 bg-[#1E293B] border-r border-[#334155]">
            <nav className="flex flex-col items-center space-y-6">
              <button 
                ...
                className={`p-2 rounded-lg transition-colors ${activeTab === 'overview' ? 'bg-[#8B5CF6] text-white shadow-md' : 'text-gray-400 hover:bg-[#334155] hover:text-white'}`}
              >
                <Activity size={20} />
              </button>
              <button 
                onClick={() => setActiveTab('workouts')} 
                className={`p-2 rounded-lg transition-colors ${activeTab === 'workouts' ? 'bg-[#8B5CF6] text-white shadow-md' : 'text-gray-400 hover:bg-[#334155] hover:text-white'}`}
              >
                <Dumbbell size={20} />
              </button>
              <button 
                onClick={() => setActiveTab('nutrition')} 
                className={`p-2 rounded-lg transition-colors ${activeTab === 'nutrition' ? 'bg-[#8B5CF6] text-white shadow-md' : 'text-gray-400 hover:bg-[#334155] hover:text-white'}`}
              >
                <BarChart3 size={20} />
              </button>
              <button 
                onClick={() => setActiveTab('goals')} 
                className={`p-2 rounded-lg transition-colors ${activeTab === 'goals' ? 'bg-[#8B5CF6] text-white shadow-md' : 'text-gray-400 hover:bg-[#334155] hover:text-white'}`}
              >
                <Trophy size={20} />
              </button>
              <button 
                onClick={() => setActiveTab('profile')} 
                className={`p-2 rounded-lg transition-colors ${activeTab === 'profile' ? 'bg-[#8B5CF6] text-white shadow-md' : 'text-gray-400 hover:bg-[#334155] hover:text-white'}`}
              >
                <User size={20} />
              </button>
        ...
        <nav className="md:hidden flex items-center justify-around bg-[#1E293B] border-t border-[#334155] px-4 py-3 rounded-b-2xl">
          <button 
            onClick={() => setActiveTab('overview')} 
            className={`p-1 flex flex-col items-center ${activeTab === 'overview' ? 'text-[#8B5CF6]' : 'text-gray-400'}`}
          >
            <Activity size={20} />
          ...
          <button 
            onClick={() => setActiveTab('workouts')} 
            className={`p-1 flex flex-col items-center ${activeTab === 'workouts' ? 'text-[#8B5CF6]' : 'text-gray-400'}`}
          >
            <Dumbbell size={20} />
          ...
          <button 
            onClick={() => setActiveTab('nutrition')} 
            className={`p-1 flex flex-col items-center ${activeTab === 'nutrition' ? 'text-[#8B5CF6]' : 'text-gray-400'}`}
          >
            <BarChart3 size={20} />
          ...
          <button 
            onClick={() => setActiveTab('profile')} 
            className={`p-1 flex flex-col items-center ${activeTab === 'profile' ? 'text-[#8B5CF6]' : 'text-gray-400'}`}
          >
            <User size={20} />
